...
public class IPFSPinataService implements IPFSService {
  ...
  public IPFSPinataService() {
    Dotenv dotenv = Dotenv.load();

    this.baseUrl = dotenv.get("PINATA_BASE_URL");
    this.apiKey = dotenv.get("PINATA_API_KEY");
    this.secretKey = dotenv.get("PINATA_SECRET_KEY");
    this.restTemplate = new RestTemplate();
  }

  public IPFSResponses.UploadImage uploadImage(String image) throws IOException
  {
